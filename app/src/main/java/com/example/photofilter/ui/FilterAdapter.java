...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.FilterViewHolder> {
    ...
    public interface OnFilterLongClickListener {
        void onFilterLongClicked(FilterItem filterItem);
    }

    private final OnFilterClickListener listener;
    private final OnFilterLongClickListener longClickListener;
    ...
    public FilterAdapter(OnFilterClickListener listener, OnFilterLongClickListener longClickListener) {
    ...
    public void submitFavorites(Set<String> favoriteFilterIds) {
        this.favoriteIds = favoriteFilterIds;
        notifyDataSetChanged();
    }
    ...
    public void onBindViewHolder(@NonNull FilterViewHolder holder, int position) {
        ...
        holder.favoriteBadge.setVisibility(favoriteIds.contains(item.getId()) ? View.VISIBLE : View.GONE);
        ...
        holder.itemView.setOnLongClickListener(v -> {
            longClickListener.onFilterLongClicked(item);
            return true;
        });
    }
    ...
    static class FilterViewHolder extends RecyclerView.ViewHolder {
        ...
        FilterViewHolder(@NonNull View itemView) {
            ...
            favoriteBadge = itemView.findViewById(R.id.favoriteBadge);
        }
    }
}
